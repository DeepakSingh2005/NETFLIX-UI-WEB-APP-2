    ...
    <div className='flex min-h-screen items-center justify-center bg-black px-4 py-10 text-white'>
      <div className='w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur'>
        ...
        <p className='mt-3 text-gray-300'>
          This is a frontend-only signup screen. No backend is connected.
        </p>

        <form className='mt-8 space-y-5'>
          <div>
            <label className='mb-2 block text-sm font-semibold text-gray-300' htmlFor='name'>
              Name
            </label>
            <input
              id='name'
        ...
        <p className='mt-6 text-sm text-gray-400'>
          ...
          <Link className='text-red-400 hover:text-red-300' to='/login'>
            Sign in
          </Link>
        </p>
      </div>
